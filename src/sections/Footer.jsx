...
const Footer = () => {
  return (
    <footer className="max-container">
              ...
              <div key={section.title}>
                ...
                <ul>
                  {section.links.map((link)=>(
                    <li className="mt-3 font-montserrat hover:text-slate-gray text-cursor-pointer text-base text-white-400" key={link.name}>
      ...
      <div className="flex justidy-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
